...
def train_step(state, memory_state, batch_inputs):
    ...
    def loss_fn(params):
        ...
        total_loss = mean_ce_loss + (0.1 * aux_loss)
...
def data_generator(file_path, tokenizer_path, batch_size, seq_len):
    ...
    print(f"Streaming dataset from {file_path} (1 Epoch)...")
    # Execute exactly 1 full epoch over the CSV
...
def main():
    ...
    print(f"\nStarting Distributed Full Training Loop (1 Epoch)...")
    ...
    print("\nPhase 1 Full Pre-Training Execution Complete! 🚀")
